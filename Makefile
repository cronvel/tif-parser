...
# JsHint STDOUT test
log/jshint.log: log/npm-dev-install.log lib/tifParser.js test/tifParser-test.js
	${JSHINT} lib/tifParser.js test/tifParser-test.js | tee log/jshint.log ; exit $${PIPESTATUS[0]}

# Mocha BDD STDOUT test
log/mocha.log: log/npm-dev-install.log lib/tifParser.js test/tifParser-test.js
	cd test ; ../${MOCHA} tifParser-test.js -R list | tee log/mocha.log ; exit $${PIPESTATUS[0]}
...
bdd-spec.md: log/npm-dev-install.log lib/tifParser.js test/tifParser-test.js
	cd test ; ../${MOCHA} tifParser-test.js -R markdown > ../bdd-spec.md

# Upgrade version in package.json
log/upgrade-package.log: lib/tifParser.js test/tifParser-test.js documentation.md
...
log/github-push.log: lib/tifParser.js test/tifParser-test.js package.json
